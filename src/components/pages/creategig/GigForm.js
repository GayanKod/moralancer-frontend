           ...
           <form onSubmit={SendGigData} >
               ...
               <div className="pricing">
                   ...
                   <ul className="gig-list">
                       ...
                       <input type='text' placeholder='Basic Pricing Description' name='Basic' 
                           onChange={(e) => {
                       ...
                       <input type='text' placeholder='Standard Pricing Description' name='Standard'
                       onChange={(e) => {
                       ...
                       <input type='text' placeholder='Premium Pricing Description' name='Premium' 
                           onChange={(e) => {
               ...
               <input type='text' placeholder='Gig Description' name='Gig-description' 
                   onChange={(e) => {
               ...
               <input type='text' placeholder='Gig requirements' name='Gig-requirements' 
                   onChange={(e) => {
