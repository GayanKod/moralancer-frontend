...
import authSvg from '../assets/img/update.svg';
          ...
          <div className='mt-12 flex flex-col items-center'>
            ...
            >
              <div className='mx-auto max-w-xs relative '>
                <input
                  disabled
                  className='w-full px-8 py-4 rounded-lg font-medium bg-red-100 border border-red-200 placeholder-red-300 text-sm focus:outline-none focus:border-red-400 focus:bg-white'
                  type='text'
                  placeholder='Role'
                  value={role}
                />
                <input
                  className='w-full px-8 py-4 rounded-lg font-medium bg-red-100 border border-red-200 placeholder-red-300 text-sm focus:outline-none focus:border-red-400 focus:bg-white mt-5'
                  type='email'
                  placeholder='Email'
                  disabled
                  value={email}
           ...
           bg-red-100 text-red-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5'
                ...
                >
                  ...
                  <span className='ml-4 text-red-500'>Home</span>
                </a>
              </div>
            </form>
          </div>
