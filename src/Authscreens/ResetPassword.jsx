...
import authSvg from '../assets/img/reset.png';
            ...
            <div className='w-full flex-1 mt-8 text-red-500'>
              ...
              >
                <input
                  ...
                  />
                  <input
                  className='w-full mt-5 px-8 py-4 rounded-lg font-medium bg-red-100 border border-red-200 placeholder-red-500 text-sm focus:outline-none focus:border-red-400 focus:bg-white'
                  type='password'
